...
parser.add_argument('--save_dir', dest='save_dir', help='The directory used to save the trained models',default='saved.pkl', type=str)
...
def main():
    ...
    train(model, train_datasets,trainloader,validloader,testloader,optimizer,device,args.epochs,args.hidden_units,\
          args.arch,args.learning_rate,args.save_dir)
